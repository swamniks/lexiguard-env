    ...
    return {
        "tasks": [
            {"id": "clause_identification", "difficulty": "easy",
             "summary": "Identify clause type (termination notice)", "has_grader": True},
            {"id": "risk_classification", "difficulty": "medium",
             "summary": "Label supplier risk level of indemnity clause", "has_grader": True},
            {"id": "contract_negotiation", "difficulty": "hard",
             "summary": "Redline to reduce supplier liability exposure", "has_grader": True},
            {"id": "compliance_check", "difficulty": "medium",
             "summary": "Identify GDPR violations in a data processing clause", "has_grader": True},
        ]
    }
